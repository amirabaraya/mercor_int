...
function getUserId(req) {
    ...
    const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET || "demo-secret");
...
async function POST(req) {
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signToken"])(user.id);
    return Response.json({
        token,
        user: {
            id: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07..f~q._.js.map